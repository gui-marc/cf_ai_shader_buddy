/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 46a0c4c3a9b03abfb1def91868b07135)
// Runtime types generated with workerd@1.20260217.0 2026-02-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/workers/shader-buddy-agent");
		durableNamespaces: "ShaderBuddyAgent";
	}
	interface Env {
		AI: Ai;
		VITE_AGENT_HOST: string;
		"shader-buddy-agent": DurableObjectNamespace<import("./src/workers/shader-buddy-agent").ShaderBuddyAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_AGENT_HOST">> {}
}
